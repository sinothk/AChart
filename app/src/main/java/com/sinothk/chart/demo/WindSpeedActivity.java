...
public class WindSpeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circularGauge.data(new SingleValueDataSet(new Double[]{currentValue}));// 指针数值
        ...
        circularGauge.label(0)
                .text("<span style=\"font-size: 25\">气流速度</span>")
                .useHtml(true)
        ...
        circularGauge.label(1)
                .text("<span style=\"font-size: 20\">  " + currentValue + "</span>") // 电子数值
                .useHtml(true)
                .hAlign(HAlign.CENTER);
